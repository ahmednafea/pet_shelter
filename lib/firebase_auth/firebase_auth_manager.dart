...
import 'package:pet_shelter/firebase_auth/backend.dart';
...
class FirebaseAuthManager extends AuthManager
  ...
  Future deleteUser(BuildContext context) async {
    try {
      if (!Shared.store!.state.identityState.currentUser!.loggedIn) {
        debugPrint('Error: delete user attempted with no logged in user!');
        return;
      }
      await Shared.store!.state.identityState.currentUser?.delete();
  ...
  Future updateEmail({
    ...
    try {
      ...
      await Shared.store!.state.identityState.currentUser?.updateEmail(email);
  ...
  Future<BaseAuthUser?> _signInOrCreateAccount(
    ...
    try {
      ...
      return userCredential == null
          ? null
          : CPMFirebaseUser.fromUserCredential(userCredential);
    } on FirebaseAuthException catch (e) {
