...
abstract class AuthManager {
  ...
  Future sendEmailVerification() async => Shared.store!.state.identityState.currentUser?.sendEmailVerification();

  Future refreshUser() async => Shared.store!.state.identityState.currentUser?.refreshUser();
}
